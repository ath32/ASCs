...
source1 <- "/Users/atho/Documents/Project_ASCs/4_Outputs/CSVs/5.2_Subset_diffs_HEGs.csv"
dataH = read.csv(source1, header = TRUE)

source2 <- "/Users/atho/Documents/Project_ASCs/4_Outputs/CSVs/5.2_Subset_diffs_LEGs.csv"
...
#CREATE DATAFRAMES FOR DIFFS
diff1 = total[["P1_Primary_TGA.y"]] - total[["P1_Primary_TAA.x"]]
diff2 = total[["P2_Primary_TGA.y"]] - total[["P2_Primary_TAA.x"]]
diff3 = total[["P3_Primary_TGA.y"]] - total[["P3_Primary_TAA.x"]]
diff4 = total[["P4_Primary_TGA.y"]] - total[["P4_Primary_TAA.x"]]
diff5 = total[["P5_Primary_TGA.y"]] - total[["P5_Primary_TAA.x"]]
diff6 = total[["P6_Primary_TGA.y"]] - total[["P6_Primary_TAA.x"]]
...
par(mfrow=c(2,3))
barplot(ordered1[["diff1"]], ylab="ASC frequency difference (TGA-HEGs - TAA-LEGs)", main="Position +1", cex.main=2, border=NA, cex.lab=1.5, col='#29B6F6')
barplot(ordered2[["diff2"]], ylab="ASC frequency difference (TGA-HEGs - TAA-LEGs)", main="Position +2", cex.main=2, border=NA, cex.lab=1.5, col='#29B6F6')
barplot(ordered3[["diff3"]], ylab="ASC frequency difference (TGA-HEGs - TAA-LEGs)", main="Position +3", cex.main=2, border=NA, cex.lab=1.5, col='#29B6F6')
barplot(ordered4[["diff4"]], ylab="ASC frequency difference (TGA-HEGs - TAA-LEGs)", main="Position +4", cex.main=2, border=NA, cex.lab=1.5, col='#29B6F6')
barplot(ordered5[["diff5"]], ylab="ASC frequency difference (TGA-HEGs - TAA-LEGs)", main="Position +5", cex.main=2, border=NA, cex.lab=1.5, col='#29B6F6')
barplot(ordered6[["diff6"]], ylab="ASC frequency difference (TGA-HEGs - TAA-LEGs)", main="Position +6", cex.main=2, border=NA, cex.lab=1.5, col='#29B6F6')
...
w1 = wilcox.test(dataL[["P1_Primary_TAA"]], dataH[["P1_Primary_TGA"]], paired = FALSE, alternative = "less")
w2 = wilcox.test(dataL[["P2_Primary_TAA"]], dataH[["P2_Primary_TGA"]], paired = FALSE, alternative = "less")
w3 = wilcox.test(dataL[["P3_Primary_TAA"]], dataH[["P3_Primary_TGA"]], paired = FALSE, alternative = "less")
w4 = wilcox.test(dataL[["P4_Primary_TAA"]], dataH[["P4_Primary_TGA"]], paired = FALSE, alternative = "less")
w5 = wilcox.test(dataL[["P5_Primary_TAA"]], dataH[["P5_Primary_TGA"]], paired = FALSE, alternative = "less")
w6 = wilcox.test(dataL[["P6_Primary_TAA"]], dataH[["P6_Primary_TGA"]], paired = FALSE, alternative = "less")
