            ...
            if '-' not in a and '-' not in b and '-' not in c:
                ...
                for i,j in enumerate(c_codons):
                    if c_codons[i] in stops:
                        ...
                        elif c_codons[i] == a_codons[i] and c_codons[i] != b_codons[i] and b_codons[i] not in stops:
                            n += 1
                            s += 1
                        elif c_codons[i] != a_codons[i] and c_codons[i] == b_codons[i] and a_codons[i] not in stops:
                            n += 1
                            s += 1
    print (s, n, s/n)
