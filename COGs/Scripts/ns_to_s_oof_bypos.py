        ...
        for f in filenames:
            ...
            if seq_list[1] != '' and seq_list[2] != '' and seq_list[3] != '':
                ...
                if '-' not in a and '-' not in b and '-' not in c:
                    a_codons = [a[i:i+3] for i in range(0, len(a)-2, 3)]
                    b_codons = [b[i:i+3] for i in range(0, len(b)-2, 3)]
                    c_codons = [c[i:i+3] for i in range(0, len(c)-2, 3)]
                    ...
                    if c1 not in stops:
                        ...
                        elif c1 == a1 and c1 != b1 and b1 in stops:
                            n1 += 1
                            s1 += 1
                        elif c1 != a1 and c1 == b1 and a1 in stops:
                            n1 += 1
                            s1 += 1
                    ...
                    if c2 not in stops:
                        ...
                        if c2 != a2 and c2 != b1:
                            ...
                            s2 += 0
                        #If C = A/B != A/b, we have an ancestral sequence and a switch, which only counts if A/B is a stop
                        elif c2 == a2 and c2 != b2 and b2 in stops:
                            n2 += 1
                            s2 += 1
                        elif c2 != a2 and c2 == b2 and a2 in stops:
                            n2 += 1
                            s2 += 1
                    ...
                    if c3 not in stops:
                        ...
                        if c3 != a3 and c3 != b3:
                            ...
                            s3 += 0
                        #If C = A/B != A/b, we have an ancestral sequence and a switch, which only counts if A/B is a stop
                        elif c3 == a3 and c3 != b3 and b3 in stops:
                            n3 += 1
                            s3 += 1
                        elif c3 != a3 and c3 == b3 and a3 in stops:
                            n3 += 1
                            s3 += 1
                    ...
                    if c4 not in stops:
                        ...
                        if c4 != a4 and c4 != b4:
                            ...
                            s4 += 0
                        #If C = A/B != A/b, we have an ancestral sequence and a switch, which only counts if A/B is a stop
                        elif c4 == a4 and c4 != b4 and b4 in stops:
                            n4 += 1
                            s4 += 1
                        elif c4 != a4 and c4 == b4 and a4 in stops:
                            n4 += 1
                            s4 += 1
                    ...
                    if c5 not in stops:
                        ...
                        if c5 != a5 and c5 != b5:
                            ...
                            s5 += 0
                        #If C = A/B != A/b, we have an ancestral sequence and a switch, which only counts if A/B is a stop
                        elif c5 == a5 and c5 != b5 and b5 in stops:
                            n5 += 1
                            s5 += 1
                        elif c5 != a5 and c5 == b5 and a5 in stops:
                            n5 += 1
                            s5 += 1
